...
source: "Datawhale / illustrated-transformer"
tags: [Transformer, Self-Attention, NLP, 编码器解码器]
---
...
[图片: Q,K,V]图：计算Query向量：$q_1, q_2$，Key向量: $k_1, k_2$，Value向量: $v_1, v_2$。
